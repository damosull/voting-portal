...
export const API = {
	...
	GET: {
		...
		GET_WD_CRITERIA_COLUMN: '**/Api/Data/MetaData/GetWdCriteriaColumnMetaData**',
		...
		LIST_SERVICE_VOTING_GROUP_VEP: '**/Api/Data/ListService/VotingGroupVep**',
		LIST_SERVICE_PRIORITY_LEVEL: '**/Api/Data/ListService/PriorityLevel**',
		LIST_SERVICE_COUNTRY: '**/Api/Data/ListService/Country**',
		LIST_SERVICE_DECISION_STATUS: '**/Api/Data//ListService/DecisionStatus**',
		...
		SITE_CONFIG: '**/Api/Data/WdSiteConfig/?InternalUserCurrentCustomerId**',
		SITE_CONFIG_ID: '**/Api/Data/WdSiteConfig/?id**',
		SITE_CONFIG_GET_DEFAULT: '**/Api/Data/WdSiteConfig/GetDefault**',
		...
		VEP_CONFIG_CRUD: '**/Api/Data/VepConfigCrud/?customerId=**',
		VEP_CRITERIA_META_DATA: '**/Api/Data/VepCriteriaMetaData/?_=**',
