...
Cypress.Commands.add('loginWithAdmin', (user) => {
	...
	cy.intercept('POST', API.POST.EXPANSION_PERFORMANCE_AGGREGATED).as('EXPANSION_PERFORMANCE_AGGREGATED');
	cy.intercept('POST', API.POST.EXPANSION_DB_AGGREGATED).as('EXPANSION_DB_AGGREGATED');
