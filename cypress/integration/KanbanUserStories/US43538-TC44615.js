...
describe('US 43538 - Ballot Vote Data Report - Add ACSI Rec column - Customer permission disabled,User permissions Enabled', function () {
    beforeEach(function () {
    ...
    it('Internal User - Update Customer and User permissions to add ACSI to Ballot Vote Data Report', function () {
        ...
        cy.get('@csrftoken').then((token) => {
            cy.request({
                ...
                custPermissions.SettingsViewModel.ViewACSI = false;
        ...
        cy.get(`#rpt-selected-columns > div > table > tbody:nth-child(2) > tr`).last().should('not.be.visible', 'ACSI')
