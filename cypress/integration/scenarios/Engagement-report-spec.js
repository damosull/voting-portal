...
describe('Generate Engagement report,download and verify file headers', function () {
    ...
    it(`Generate Report`, function () {
        ...
        cy.get('#discrete-date-start-InteractionDate').clear({force:true}).type('05/07/2021')
        cy.get('#discrete-date-end-InteractionDate').clear({ force: true }).type('05/28/2021')
        ...
        cy.get('#inbox-container .msg-txt')
            .should(($msg) => {
