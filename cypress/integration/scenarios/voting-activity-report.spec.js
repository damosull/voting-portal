...
describe('Regression Viewpoint', () => {
  ...
  const fileExtension = 'xlsx'; /* options: xls or xlsx */
  ...
  context('Workflow 3 - Original', () => {
    it(`Viewpoint Reporting - Create, download and verify ${upperFileExt} voting-activity report`, () => {
      ...
      // I added this block code get the current CSRF token and wrapped into the variable csrftoken so it can be re-used across the script
